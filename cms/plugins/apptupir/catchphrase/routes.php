...
use AppTupir\Catchphrase\Http\Controllers\CreatorSearchController;
use AppTupir\Catchphrase\Http\Controllers\CatchphraseSearchController;
...
Route::group([
    ...
    $router->get('catchphrases/search/{name}', [CatchphraseSearchController::class, "show"]);

    $router->get('creators', [CreatorsController::class, 'index']);
    $router->get('creators/{id}', [CreatorsController::class, 'show']);
    $router->get('creators/search/{name}', [CreatorSearchController::class, "show"]);
